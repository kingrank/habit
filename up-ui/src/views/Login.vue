        ...
        <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
            ...
            <el-form-item prop="account">
                <el-input v-model="loginForm.account" type="text" auto-complete="off" placeholder="账号">
                    <i slot="prefix" class="icon iconfont icon-user el-input__icon input-icon"></i>
                </el-input>
            </el-form-item>
            <el-form-item prop="password">
                <el-input v-model="loginForm.password" type="password" auto-complete="off" placeholder="密码" @keyup.enter.native="handleLogin">
                    <i slot="prefix" class="icon iconfont icon-lock el-input__icon input-icon"></i>
                </el-input>
            </el-form-item>
            <el-form-item prop="code">
                <el-input v-model="loginForm.code" auto-complete="off" placeholder="验证码" style="width: 63%" @keyup.enter.native="handleLogin">
                    <i slot="prefix" class="icon iconfont icon-safetycertificate el-input__icon input-icon"></i>
                </el-input>
...
<script>
    ...
    export default {
        ...
        methods: {
            getImageCode() {
                captcha(ok => {
                    this.loginForm.uuid = ok.data.uuid;
                    this.codeUrl = ok.data.image;
                })
            },
            getCookie() {
