...
public class Org extends DBModel<Org> implements IBean {
	/**表名*/
    public final static String TABLE_NAME="cm_org";
    /**主键*/
    ...
    public final static String TABLE_INFO="<table style='font-size:14px; font-style:normal'>"
            ...
            +("<tr><td>ancestors</td><td>父级列表</td></tr>")
	 ...
	 * 父级列表
	 */
	public Org setAncestors(String ancestors) {
	 ...
	 * 负责人
	 */
	public Org setLeader(String leader) {
		set("leader", leader);
		return this;
	}
	 ...
	 * 联系电话
	 */
	public Org setPhone(String phone) {
		set("phone", phone);
		return this;
	}
	 ...
	 * 部门状态@0:正常,1:停用
	 */
	public Org setState(Integer state) {
		set("state", state);
		return this;
	}
	 ...
	 * 删除标志@0:存在,1:删除
	 */
	public Org setIsDel(Integer isDel) {
		set("is_del", isDel);
		return this;
	}
	 ...
	 * 创建者
	 */
	public Org setCreateBy(Integer createBy) {
	 ...
	 * 创建时间
	 */
	public Org setCreateTime(java.util.Date createTime) {
	 ...
	 * 更新者
	 */
	public Org setModifyBy(Integer modifyBy) {
	 ...
	 * 更新时间
	 */
	public Org setModifyTime(java.util.Date modifyTime) {
